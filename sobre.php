...
<style>
.cabecalho {
  background-image: url('<?=get_template_directory_URI()?>/img/rsc/banner_sobre.png');
}
</style>
...
<div class=" cabecalho">
  ...
  <!-- <div class="cabecalho-img">
    <picture>
      ...
      <img src="<?=get_template_directory_URI()?>/img/rsc/sobre.jpg">
    </picture>
  </div> -->
</div>
...
<section class="nossos-servicos">
  <div class="servicos-seta fadeRight" data-animar>
